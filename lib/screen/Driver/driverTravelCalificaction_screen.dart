...
import 'package:speed/controllers/Driver/driverTravelCalification_controller.dart';

class DriverTravelCalification extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GetBuilder<DriverTravelCalificationController>(
      init: DriverTravelCalificationController(),
